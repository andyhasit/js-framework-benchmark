  ...
  <div class="container">
    <div class="jumbotron">
      <div class="row">
        ...
        <div class="col-md-6">
          <Button props={{ id: "run", title: "Create 1,000 rows", fn: run }} />
          <Button
            props={{ id: "runlots", title: "Create 10,000 rows", fn: runLots }}
          />
          <Button props={{ id: "add", title: "Append 1,000 rows", fn: add }} />
          <Button
            props={{
              id: "update",
          ...
          />
          <Button props={{ id: "clear", title: "Clear", fn: clear }} />
          <Button
            props={{ id: "swaprows", title: "Swap rows", fn: swapRows }}
          />
        </div>
      </div>
    </div>
...
const Row = (
  <tr className={isSelected(p) | (n ? "danger" : "")}>
    <td class="col-md-1">{null | p.id}</td>
    <td class="col-md-4">
